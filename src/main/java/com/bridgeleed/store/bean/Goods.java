...
public class Goods implements Serializable {
	...
	private static final long serialVersionUID = 3757475165403280141L;
	private String id;
	...
	public String toString() {
		return "Goods [id=" + id + ", categoryId=" + categoryId + ", itemType=" + itemType + ", title=" + title
				...
				+ ", getId()=" + getId() + ", getCategoryId()=" + getCategoryId() + ", getItemType()=" + getItemType()
				+ ", getTitle()=" + getTitle() + ", getSellPoint()=" + getSellPoint() + ", getPrice()=" + getPrice()
				+ ", getNum()=" + getNum() + ", getBarcode()=" + getBarcode() + ", getImage()=" + getImage()
				+ ", getStatus()=" + getStatus() + ", getPriority()=" + getPriority() + ", getCreatedUser()="
				+ getCreatedUser() + ", getCreatedTime()=" + getCreatedTime() + ", getModifiedUser()="
				+ getModifiedUser() + ", getModifiedTime()=" + getModifiedTime() + ", hashCode()=" + hashCode()
