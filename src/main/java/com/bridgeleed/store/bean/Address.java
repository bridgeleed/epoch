package com.bridgeleed.store.bean;
...
public class Address implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3877767665415401973L;
	private Integer id;
	private Integer uid;
	...
	public String toString() {
		return "Address [id=" + id + ", uid=" + uid + ", recvName=" + recvName + ", recvCity=" + recvCity
				+ ", recvProvince=" + recvProvince + ", recvArea=" + recvArea + ", recvDistrict=" + recvDistrict
				...
				+ ", getId()=" + getId() + ", getUid()=" + getUid() + ", getRecvName()=" + getRecvName()
				+ ", getRecvCity()=" + getRecvCity() + ", getRecvProvince()=" + getRecvProvince() + ", getRecvArea()="
				+ getRecvArea() + ", getRecvDistrict()=" + getRecvDistrict() + ", getRecvAddress()=" + getRecvAddress()
				+ ", getRecvPhone()=" + getRecvPhone() + ", getRecvTel()=" + getRecvTel() + ", getRecvZip()="
				+ getRecvZip() + ", getRecvTag()=" + getRecvTag() + ", getIsDefault()=" + getIsDefault()
