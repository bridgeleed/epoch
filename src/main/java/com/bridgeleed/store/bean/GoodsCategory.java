...
public class GoodsCategory implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7558809051428951245L;
	private Integer id;
	...
	public String toString() {
		return "GoodsCategory [id=" + id + ", parentId=" + parentId + ", name=" + name + ", status=" + status
				...
				+ ", getId()=" + getId() + ", getParentId()=" + getParentId() + ", getName()=" + getName()
				+ ", getStatus()=" + getStatus() + ", getSortOrder()=" + getSortOrder() + ", getIsParent()="
				+ getIsParent() + ", getCreatedUser()=" + getCreatedUser() + ", getCreatedTime()=" + getCreatedTime()
